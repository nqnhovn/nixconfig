...
NIX_CFLAGS_COMPILE=' -frandom-seed=kgcw29kdl7 -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/p8x5zv9s9qg3ld8b7jdm03hkpdqybjl9-jq-1.8.1-dev/include -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/p8x5zv9s9qg3ld8b7jdm03hkpdqybjl9-jq-1.8.1-dev/include'
...
prefix='/nix/store/kgcw29kdl7qnnjij2r4iqhyaq7jy9yga-devenv-shell-env'
shell='/nix/store/i27rhb3nr65rkrwz36bchkwmav6ggsmn-bash-5.3p9/bin/bash'
export shell
...
LD='ld'
export LD
NIX_LDFLAGS='-rpath /nix/store/kgcw29kdl7qnnjij2r4iqhyaq7jy9yga-devenv-shell-env/lib  -L/nix/store/09bq2i0kb008ccg3qdbyxv81ggxxnn09-jq-1.8.1/lib -L/nix/store/09bq2i0kb008ccg3qdbyxv81ggxxnn09-jq-1.8.1/lib'
export NIX_LDFLAGS
NIX_STORE='/nix/store'
export NIX_STORE
...
out='/nix/store/kgcw29kdl7qnnjij2r4iqhyaq7jy9yga-devenv-shell-env'
export out
...
export SHELL="$(command -v /run/current-system/sw/bin/zsh)"
