...
prefix='/nix/store/p49iv03bhm0hkqwccjz4j0a8v0a2svkq-devenv-shell-env'
CXX='g++'
export CXX
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/jjxngswsb214vb58qx485jhmilf0kxxy-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/zn1plyasl8y56hv6fs09p52dbz5fg5df-devenv-profile" ]
then
  ln -snf /nix/store/zn1plyasl8y56hv6fs09p52dbz5fg5df-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
patches=''
export patches
NIX_LDFLAGS='-rpath /nix/store/p49iv03bhm0hkqwccjz4j0a8v0a2svkq-devenv-shell-env/lib  -L/nix/store/09bq2i0kb008ccg3qdbyxv81ggxxnn09-jq-1.8.1/lib -L/nix/store/09bq2i0kb008ccg3qdbyxv81ggxxnn09-jq-1.8.1/lib'
export NIX_LDFLAGS
IFS=' 	
'
STRINGS='strings'
...
NIX_CFLAGS_COMPILE=' -frandom-seed=p49iv03bhm -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/p8x5zv9s9qg3ld8b7jdm03hkpdqybjl9-jq-1.8.1-dev/include -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/p8x5zv9s9qg3ld8b7jdm03hkpdqybjl9-jq-1.8.1-dev/include'
...
'
export buildPhase
out='/nix/store/p49iv03bhm0hkqwccjz4j0a8v0a2svkq-devenv-shell-env'
export out
...
DEVENV_PROFILE='/nix/store/zn1plyasl8y56hv6fs09p52dbz5fg5df-devenv-profile'
...
exec /tmp/devenv-envz5Jdxz/script 