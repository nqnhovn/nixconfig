...
out='/nix/store/ikpmh8dcr0w7z8pfhvfkyj13557nx5p7-devenv-shell-env'
export out
...
NIX_STORE='/nix/store'
export NIX_STORE
DEVENV_PROFILE='/nix/store/ihfcixc7w8sl86j3fknw6h1qqx47hnf4-devenv-profile'
...
outputDevdoc='REMOVE'
prefix='/nix/store/ikpmh8dcr0w7z8pfhvfkyj13557nx5p7-devenv-shell-env'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/jjxngswsb214vb58qx485jhmilf0kxxy-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/ihfcixc7w8sl86j3fknw6h1qqx47hnf4-devenv-profile" ]
then
  ln -snf /nix/store/ihfcixc7w8sl86j3fknw6h1qqx47hnf4-devenv-profile "$DEVENV_DOTFILE/profile"
fi
